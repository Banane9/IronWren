...
namespace IronWren.FullyAutoMapper
{
    ...
    /// </summary>
    public static class FullyAutoMapper
    {
        /// <summary>
        ...
        /// </summary>
        private static readonly ConditionalWeakTable<WrenVM, Dictionary<string, FullyAutoForeignModule>> generatedModules =
            new ConditionalWeakTable<WrenVM, Dictionary<string, FullyAutoForeignModule>>();

        private static readonly ConditionalWeakTable<WrenVM, Dictionary<string, FullyAutoForeignClass>> mainModuleClasses =
            new ConditionalWeakTable<WrenVM, Dictionary<string, FullyAutoForeignClass>>();
        ...
        public static void FullyAutoMap<TTarget>(this WrenVM vm, string moduleName = WrenVM.MainModule)
        {
            vm.FullyAutoMap(moduleName, typeof(TTarget));
        }
        ...
        public static void FullyAutoMap(this WrenVM vm, params Type[] targets)
        {
            vm.FullyAutoMap(WrenVM.MainModule, targets);
        }
        ...
        /// <param name="targets">The types to map.</param>
        public static void FullyAutoMap(this WrenVM vm, string moduleName, params Type[] targets)
        {
            ...
            if (moduleName == WrenVM.MainModule)
            {
                ...
                {
                    var foreignClass = new FullyAutoForeignClass(target);
            ...
            {
                module = new FullyAutoForeignModule();
        ...
        private static void checkInitialization(WrenVM vm)
        {
            ...
            generatedModules.Add(vm, new Dictionary<string, FullyAutoForeignModule>());
            mainModuleClasses.Add(vm, new Dictionary<string, FullyAutoForeignClass>());
        }
